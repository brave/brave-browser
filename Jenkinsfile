    ...
    stages {       
        ...
        stage('test-unit') {
            steps {
                ...
                xunit thresholds: [failed(failureNewThreshold: '0', failureThreshold: '2', unstableNewThreshold: '0', unstableThreshold: '1')], tools: [GoogleTest(deleteOutputFiles: true, failIfNotNew: true, pattern: 'src/brave_unit_tests.xml', skipNoTestFiles: false, stopProcessingIfError: true)]
            }
        }
        stage('test-browser') {
            steps {
                ...
                xunit thresholds: [failed(failureNewThreshold: '0', failureThreshold: '2', unstableNewThreshold: '0', unstableThreshold: '1')], tools: [GoogleTest(deleteOutputFiles: true, failIfNotNew: true, pattern: 'src/brave_browser_tests.xml', skipNoTestFiles: false, stopProcessingIfError: true)]
            }   
        }                
    }
    // post {
