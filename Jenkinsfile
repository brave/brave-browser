                                ...
                                timeout(time: 20, unit: "MINUTES") {
                                    script {
                                        try {
                                            ...
                                            xunit([GoogleTest(pattern: "src/brave_unit_tests.xml", deleteOutputFiles: true, failIfNotNew: true, skipNoTestFiles: false, stopProcessingIfError: false)])
                                            xunit([GoogleTest(pattern: "src/brave_installer_unittests.xml", deleteOutputFiles: true, failIfNotNew: true, skipNoTestFiles: false, stopProcessingIfError: false)])
                                        }
                                        catch (ex) {
                                            echo ex.toString()
                                            currentBuild.result = "UNSTABLE"
                                ...
                                timeout(time: 20, unit: "MINUTES") {
                                    script {
                                        try {
                                            ...
                                            xunit([GoogleTest(pattern: "src/brave_browser_tests.xml", deleteOutputFiles: true, failIfNotNew: true, skipNoTestFiles: false, stopProcessingIfError: false)])
                                        }
                                        catch (ex) {
                                            echo ex.toString()
                                            currentBuild.result = "UNSTABLE"
