pipeline {
    ...
    parameters {
        ...
        string(name: "CHROMIUM_SRC", defaultValue: "https://github.com/brave-chromium/chromium-81.0.4044.83.git", description: "or use https://chromium.googlesource.com/chromium/src.git")
