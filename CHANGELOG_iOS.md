...
## [1.66.123](https://github.com/brave/brave-browser/releases/tag/v1.66.123)
 ...
 - Fixed "Add to Calendar" prompt not displaying when invite URLs are loaded on NTP and other websites. ([#38548](https://github.com/brave/brave-browser/issues/38548))
