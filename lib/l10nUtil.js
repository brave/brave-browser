...
// Modify strings to support Android extensions
const extensionsChromeStringsPath = path.resolve(path.join(srcDir, 'extensions', 'strings', 'extensions_strings.grd'))
const braveExtenstionsChromeStringsPath = path.resolve(path.join(srcDir, 'brave', 'extensions', 'strings', 'extensions_strings.grd'))
const uiResourcesChromeStringsPath = path.resolve(path.join(srcDir, 'ui', 'resources', 'ui_resources.grd'))
const braveUiResourcesChromeStringsPath = path.resolve(path.join(srcDir, 'brave', 'ui', 'resources', 'ui_resources.grd'))
const themeResourcesChromeStringsPath = path.resolve(path.join(srcDir, 'chrome', 'app', 'theme', 'theme_resources.grd'))
const braveThemeResourcesChromeStringsPath = path.resolve(path.join(srcDir, 'brave', 'app', 'theme', 'theme_resources.grd'))
const browserResourcesChromeStringsPath = path.resolve(path.join(srcDir, 'chrome', 'browser', 'browser_resources.grd'))
const braveBrowserResourcesChromeStringsPath = path.resolve(path.join(srcDir, 'brave', 'browser', 'browser_resources.grd'))
const mojoBindingsResourcesChromeStringsPath = path.resolve(path.join(srcDir, 'mojo', 'public', 'js', 'mojo_bindings_resources.grd'))
const braveMojoBindingsResourcesChromeStringsPath = path.resolve(path.join(srcDir, 'brave', 'mojo', 'public', 'js', 'mojo_bindings_resources.grd'))
...
const grdsWithAutoAddedGrdps = {
  ...
  ...AddGrd(extensionsChromeStringsPath, braveExtenstionsChromeStringsPath),
  ...AddGrd(uiResourcesChromeStringsPath, braveUiResourcesChromeStringsPath),
  ...AddGrd(themeResourcesChromeStringsPath, braveThemeResourcesChromeStringsPath),
  ...AddGrd(browserResourcesChromeStringsPath, braveBrowserResourcesChromeStringsPath),
  ...AddGrd(mojoBindingsResourcesChromeStringsPath, braveMojoBindingsResourcesChromeStringsPath)
}
...
const fixupReplacements = [
  ...
  [/Brave Talk/g, 'Google Talk'],
  [/Brave Dev Editor/g, 'Google Dev Editor'],
  [/Brave Hangouts/g, 'Google Hangouts'],
]
