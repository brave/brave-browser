...
const util = {
  ...
  updateBranding: () => {
    ...
    autoGeneratedBraveToChromiumMapping[path.join(braveAndroidDir, 'java', 'strings', 'brave_android_chrome_strings.grd')] = path.join(chromeAndroidDir, 'java', 'strings', 'brave_android_chrome_strings.grd')
