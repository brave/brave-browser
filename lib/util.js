...
const util = {
  ...
  updateBranding: () => {
    ...
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'generated_resources.grd')] = path.join(chromeAppDir, 'generated_resources.grd')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'bookmarks_strings.grdp')] = path.join(chromeAppDir, 'bookmarks_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'app_management_strings.grdp')] = path.join(chromeAppDir, 'app_management_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'media_router_strings.grdp')] = path.join(chromeAppDir, 'media_router_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'global_media_controls_strings.grdp')] = path.join(chromeAppDir, 'global_media_controls_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'profiles_strings.grdp')] = path.join(chromeAppDir, 'profiles_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'os_settings_strings.grdp')] = path.join(chromeAppDir, 'os_settings_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'settings_strings.grdp')] = path.join(chromeAppDir, 'settings_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'extensions_strings.grdp')] = path.join(chromeAppDir, 'extensions_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'welcome_strings.grdp')] = path.join(chromeAppDir, 'welcome_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'printing_strings.grdp')] = path.join(chromeAppDir, 'printing_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'vr_strings.grdp')] = path.join(chromeAppDir, 'vr_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'xr_consent_ui_strings.grdp')] = path.join(chromeAppDir, 'xr_consent_ui_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'supervised_user_error_page_strings.grdp')] = path.join(chromeAppDir, 'supervised_user_error_page_strings.grdp')
    // components/components_strings.grd and all of its parts
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'components_strings.grd')] = path.join(chromeComponentsDir, 'components_strings.grd')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'app_modal_strings.grdp')] = path.join(chromeComponentsDir, 'app_modal_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'autofill_assistant_strings.grdp')] = path.join(chromeComponentsDir, 'autofill_assistant_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'autofill_payments_strings.grdp')] = path.join(chromeComponentsDir, 'autofill_payments_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'autofill_strings.grdp')] = path.join(chromeComponentsDir, 'autofill_strings.grdp')
    ...
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'bookmark_component_strings.grdp')] = path.join(chromeComponentsDir, 'bookmark_component_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'browsing_data_strings.grdp')] = path.join(chromeComponentsDir, 'browsing_data_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'components_settings_strings.grdp')] = path.join(chromeComponentsDir, 'components_settings_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'crash_strings.grdp')] = path.join(chromeComponentsDir, 'crash_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'dialog_strings.grdp')] = path.join(chromeComponentsDir, 'dialog_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'dom_distiller_strings.grdp')] = path.join(chromeComponentsDir, 'dom_distiller_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'error_page_strings.grdp')] = path.join(chromeComponentsDir, 'error_page_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'find_in_page_strings.grdp')] = path.join(chromeComponentsDir, 'find_in_page_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'flags_strings.grdp')] = path.join(chromeComponentsDir, 'flags_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'history_strings.grdp')] = path.join(chromeComponentsDir, 'history_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'login_dialog_strings.grdp')] = path.join(chromeComponentsDir, 'login_dialog_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'media_message_center_strings.grdp')] = path.join(chromeComponentsDir, 'media_message_center_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'new_or_sad_tab_strings.grdp')] = path.join(chromeComponentsDir, 'new_or_sad_tab_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'ntp_snippets_strings.grdp')] = path.join(chromeComponentsDir, 'ntp_snippets_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'omnibox_strings.grdp')] = path.join(chromeComponentsDir, 'omnibox_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'page_info_strings.grdp')] = path.join(chromeComponentsDir, 'page_info_strings.grdp')
    ...
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'payments_strings.grdp')] = path.join(chromeComponentsDir, 'payments_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'pdf_strings.grdp')] = path.join(chromeComponentsDir, 'pdf_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'policy_strings.grdp')] = path.join(chromeComponentsDir, 'policy_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'print_media_strings.grdp')] = path.join(chromeComponentsDir, 'print_media_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'printing_component_strings.grdp')] = path.join(chromeComponentsDir, 'printing_component_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'reset_password_strings.grdp')] = path.join(chromeComponentsDir, 'reset_password_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'safe_browsing_strings.grdp')] = path.join(chromeComponentsDir, 'safe_browsing_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'security_interstitials_strings.grdp')] = path.join(chromeComponentsDir, 'security_interstitials_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'security_state_strings.grdp')] = path.join(chromeComponentsDir, 'security_state_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'ssl_errors_strings.grdp')] = path.join(chromeComponentsDir, 'ssl_errors_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'sync_ui_strings.grdp')] = path.join(chromeComponentsDir, 'sync_ui_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'translate_strings.grdp')] = path.join(chromeComponentsDir, 'translate_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'undo_strings.grdp')] = path.join(chromeComponentsDir, 'undo_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveComponentsDir, 'version_ui_strings.grdp')] = path.join(chromeComponentsDir, 'version_ui_strings.grdp')
