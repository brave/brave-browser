...
const util = {
  ...
  gitGetModifiedPaths: async function (gitRepoPath, verbose = false, logError = false) {
    const modifiedDiffArgs = ['diff', '--diff-filter=M', '--name-only', '--ignore-space-at-eol']
    const cmdOutput = await util.runGitAsync(gitRepoPath, modifiedDiffArgs, verbose, logError)
