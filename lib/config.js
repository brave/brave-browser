...
Config.prototype.buildArgs = function () {
  ...
  if ((process.platform === 'win32'|| options.target_os === 'win') && this.build_omaha) {
  ...
  if (this.sccache && (process.platform === 'win32' || options.target_os === 'win')) {
  ...
  if (process.platform === 'win32' || options.target_os === 'win') {
...
Config.prototype.update = function (options) {
  ...
  if ((process.platform === 'win32' || options.target_os === 'win') && options.build_omaha) {
