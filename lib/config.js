...
const Config = function () {
  ...
  this.targetArch = 'x64'
  this.sccache = getNPMConfig(['sccache']) || false
...
Config.prototype.buildArgs = function () {
  ...
  if (this.sccache) {
    args.symbol_level = 1 // Low cache hit % when set to 2
  }
...
Config.prototype.update = function (options) {
  ...
  if (options.sccache) this.sccache = options.sccache
...
Object.defineProperty(Config.prototype, 'defaultOptions', {
  get: function () {
    ...
    if (this.sccache) env.CC_WRAPPER = 'sccache'
