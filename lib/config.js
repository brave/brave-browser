...
Config.prototype.buildArgs = function () {
  ...
  let args = {
    ...
    // Should not be empty as causes build error in gn 'You can't use empty strings as directories'
    brave_android_keystore_path: getNPMConfig(['brave_android_keystore_path']) || '.',
    brave_android_keystore_name: this.braveAndroidKeystoreName,
    brave_android_keystore_password: this.braveAndroidKeystorePassword,
    brave_android_key_password: this.braveAndroidKeyPassword,
    ...this.extraGnArgs,
  }
...
Config.prototype.shouldSign = function () {
  ...
  return !this.skip_signing &&
         ...
         ((this.mac_signing_identifier !== '' &&
         this.targetOS !== 'ios') ||
         (this.targetOS === 'android' &&
         this.braveAndroidKeystorePath !== ''))
}
