...
Config.prototype.buildArgs = function () {
  ...
  if ((process.platform === 'win32'|| this.targetOS === 'win') && this.build_omaha) {
  ...
  if (this.sccache && (process.platform === 'win32' || this.targetOS === 'win')) {
  ...
  if (process.platform === 'win32' || this.targetOS === 'win') {
...
Config.prototype.update = function (options) {
  ...
  if ((process.platform === 'win32' || this.targetOS === 'win') && options.build_omaha) {
