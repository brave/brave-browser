...
const Config = function () {
  ...
  this.googleApiKey = 'AIzaSyAQfxPJiounkhOjODEO5ZieffeBv6yft2Q'
  this.googleApiEndpoint = 'https://www.googleapis.com/geolocation/v1/geolocate?key='
  this.electronVersion = getNPMConfig(['electron_version']) || "0.1.0"
  this.buildProjects()
}
