...
## [0.63.48](https://github.com/brave/brave-browser/releases/tag/v0.63.48)
 ...
 - Fix issue with shields panel on Manjaro/Arch Linux.([#1555](https://github.com/brave/brave-browser/issues/1555))
 - Restore "Clickable area" on new tab page tiles.([#3487](https://github.com/brave/brave-browser/issues/3487))
 ...
 - Fix printing problems with www.wsj.com.([#2286](https://github.com/brave/brave-browser/issues/2286))
 - Fix context menu hang on mobile.twitter.com.([#2410](https://github.com/brave/brave-browser/issues/2410))
 - Fix Rewards auto-contribute table not being updated correctly.([#2911](https://github.com/brave/brave-browser/issues/2911))
 - Videos don't play on videoportal.joj.sk.([#2931](https://github.com/brave/brave-browser/issues/2931))
 - Fix bug with excluding sites from the Rewards auto-contribute table.([#2943](https://github.com/brave/brave-browser/issues/2943))
 - Fix crash when trying to open brave://sync in tor window.([#3003](https://github.com/brave/brave-browser/issues/3003))
 - Fix crash when trying to open brave://sync in Guest Window.([#3522](https://github.com/brave/brave-browser/issues/3522))
 ...
 - Tipping panel view not showing on some YouTube channels.([#3335](https://github.com/brave/brave-browser/issues/3335))
 ...
 - Checkboxes now use Brave color palette.([#3377](https://github.com/brave/brave-browser/issues/3377))
 - Buttons now use Brave brand style.([#3378](https://github.com/brave/brave-browser/issues/3378))
 ...
 - Brave:// pages show up in browsing history.([#3493](https://github.com/brave/brave-browser/issues/3493))
 - Panel is not updated immediately .([#3497](https://github.com/brave/brave-browser/issues/3497))
 - Don't sync bookmarks if chain is not fully created.([#2687](https://github.com/brave/brave-browser/issues/2687))
 - Fix bug where not all bookmarks get synced.([#3777](https://github.com/brave/brave-browser/issues/3777))
 - Fix Rewards auto-contribute table corruption that occurred after update.([#3510](https://github.com/brave/brave-browser/issues/3510))
 - Excluded publisher included back in.([#3551](https://github.com/brave/brave-browser/issues/3551))
 - Fix bug with new tab page dropping omnibox input while it's loading.([#3756](https://github.com/brave/brave-browser/issues/3756))
 - Show correct favicon for verified sites in Rewards panel.([#3783](https://github.com/brave/brave-browser/issues/3783))
 - Fix bug which claimed there was insufficient funds (when wallet has BAT).([#3897](https://github.com/brave/brave-browser/issues/3897))
 - Added support for Brave on Ubuntu 19.04 "Disco Dingo".([#4157](https://github.com/brave/brave-browser/issues/4157))
 - Upgrade Chromium 74.0.3729.91 to Chromium 74.0.3729.108.([#4192](https://github.com/brave/brave-browser/issues/4192))
...
## [0.60.45](https://github.com/brave/brave-browser/releases/tag/v0.60.45)
 ...
 - Added backup wallet notification under rewards panel that notifies users who have not backed up their wallet. ([#1164](https://github.com/brave/brave-browser/issues/1164))
 - Added notification under rewards panel that appears three days before contribution if wallet has insufficient BAT. ([#1479](https://github.com/brave/brave-browser/issues/1479))
 ...
 - Fixed URL and icons under rewards panel mismatching in some cases. ([#2073](https://github.com/brave/brave-browser/issues/2073))
...
## [0.59.34](https://github.com/brave/brave-browser/releases/tag/v0.59.34)
 ...
 - Fixed rewards panel not always displaying Welcome screen on first click which caused issues creating wallets. ([#2962](https://github.com/brave/brave-browser/issues/2962))
