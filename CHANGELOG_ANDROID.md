...
## [1.42.86](https://github.com/brave/brave-browser/releases/tag/v1.42.86)
 ...
 - Added pending request notification to Wallet's icon badge for Decrypt screen. ([#23613](https://github.com/brave/brave-browser/issues/23613))
 - Improved Wallet UI on various screens to show the gradient color when selected. ([#23556](https://github.com/brave/brave-browser/issues/23556))
